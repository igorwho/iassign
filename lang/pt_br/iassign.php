...
$string['activities_page_help']           = 'Opções gerenciais relacionadas com atividades do bloco';
...
$string['add_ilm_iassign_help']           = 'Adicionar um novo <a href="https://www.matematica.br/ia/#iLM" title="veja uma descrição mais completa aqui" target="_blank">iMA</a>, ' .
  ' preenchendo um formulário e enviando um ZIP (ou JAR) com o iMA. Atenção: No caso de pacote HTML/JS o "index.html" deve estar na raíz do ZIP.';
$string['add_ilm_iassign_about_ilm']      = 'Um <a href="https://www.matematica.br/ia/#iLM" title="ver uma descrição mais completa" target="_blank">iLM</a> é qualquer sisstema educacional via Web';
$string['add_param']                      = 'Adicionar novo parâmetro';
$string['all_submissions_manager']        = 'Gerenciar todas as submissões';
$string['all_submissions_manager_help']   = 'Página que permite gerenciar todos os envios de todos os estudantes, por atividade';
...
$string['auto_evaluate_name_config_help'] = 'Página para selecionar atividades (deste bloco) para serem reavaliadas';
...
$string['coefficient_variation_title']    = 'Variância (PV) - sobre NS';
$string['comment']                        = 'Comentários';
$string['comment_not_answer_this']        = 'Não responda a esta mensagem';
...
$string['confirm_del_iassign']            = 'Atividade excluída com sucesso.';
$string['confirm_del_ilm']                = 'Você tem certeza que deseja excluir o iMA <b>{$a}</b> ?';
$string['confirm_del_ilm_sure1']          = 'Este iMA tem {$a->num} submissões em suas atividades! Veja seu identificador ({$a->id}) e número de envíos a seguir:';
$string['confirm_del_ilm_sure2']          = 'Clique para verificar esta atividade (id, #submissões) - você deverá trocar seus iMA';
$string['confirm_del_ilm_sure3']          = 'Este iMA tem {$a->num} atividades! Antes de decidir removê-lo, confira/anotes seus ID: {$a->id}';
...
$string['data_file_html_static']          = "Para adicionar um iMA (codificado em HTML/JavaScript), basta enviar o pacote correspondente
 em um arquivo do tipo ZIP no campo abaixo. Também é possível adicionar um iMA no antigo formato applet/Java, enviando um pacote JAR no campo seguinte.";
...
$string['error_confirm_del_iassign']      = 'Ocorreu algum erro ao tentar remover uma tarefa. Por favor, avise ao administrador/professor';
...
$string['error_duplicated_activity_1']    = 'Error: ocorreu algum erro durante a duplicação da atividade!';
...
$string['error_exercise_removed']         = 'Ocorreu algum erro. Talvez seu professor tenha removido ou trocado o arquivo deste exercício. '.
  'Por favor, comunique o ocorrido com seu professor ou ao administrador.';
$string['error_file_dupl_1']              = 'Erro: não foi possível duplicar o arquivo, talvez ele já exista!';
...
$string['error_file_not_exists']          = 'Erro: arquivo não existente!';
$string['error_file_null_iassign']        = 'Erro: O nome do arquivo está vazio.';
$string['error_folder_permission_denied'] = 'Erro: não existe permissão para modificar os arquivos no diretório de iMA.' . 
  'Por favor, você precisa verificar as permissões do diretório de iMA (prerrogativa de admin Moodle)';
$string['error_folder_permission_create'] = 'iMA erro de criação: diretório sem permissão';
$string['error_folder_permission_dir']    = 'Diretório: ';
$string['error_folder_permission_ilmdir'] = 'Diretório do iMA: ';
$string['error_folder_permission_ilmver'] = 'Diretório da versão do iMA: ';
...
$string['error_import_ilm_version_type']  = 'Nome, versão e tipo: ';
$string['error_import_ilm_version_exist'] = 'Já existe um iMA com este nome e versão';
...
$string['error_xml_ilm']                  = 'Erro: o arquivo descritor (XML descrevendo a estrutura do iMA) não foi encontrado no pacote ou está corrompido.';
...
$string['error_zip_ipz']                  = 'Erro de criação de iMA: falha no pacote ZIP ou IPZ';
$string['error_zip_ipz_more_directories'] = 'Foram encontrados ao menos dois sub-diretórios distintos no pacote: "{$a}" e "{$b}"';
$string['error_zip_ipz_file_in_pack']     = 'Foi encontrado um arquivo (que não o "ilm-application.xml") ao nível raíz do pacote:';
$string['error_zip_ipz_single_directory'] = 'Erro! O pacote ZIP ou IPZ deve ter todos seus arquivos dentro de um único diretório.';
...
$string['export_csv_help']                = 'Exportar um arquivo CSV com as notas de todas atividades de todos os alunos';
$string['export_all_submissions']         = 'Exportar submissões';
$string['export_all_submissions_help']    = 'Exportar um pacote ZIP com todas as submissões de todos os alunos para cada uma das iActividades';
...
$string['file_class_form']                = 'Explicações sobre o campo ("file_class")';
$string['file_class_form_help']           = 'Considerano iMA codificado em HTML/JavaScript, esse campo deve ter seu HTML inicial.' .
        'Considerando iMA em Java, o campo "file_class" deve conter sua a classe principal (e.g. "IgeomApplet" para o iGeom).';
...
$string['file_ilm_recover_help']          = 'Esta operação irá recuperar todos os arquivos utilizados em atividades neste curso na pasta atual.<br>'. 
        'O nome dos arquivos serão os nomes das atividades.';
$string['file_jar']                       = 'Nome do diretório principal (HTML/JS) ou do pacote (Java/JAR)';
$string['file_jar_help']                  = 'Explicações adicionais sobre o campo "file_jar"';
$string['file_jar_help_help']             = 'Para iMA implementado em HTML/JavaScript: esse campo deve conter o nome de seu arquivo HTML inicial (deve incluir o prefixo "ilm/").'.
        'Para iMA implementado em Java: esse campo deve conter o nome de seu arquivo JAR';
$string['file_jar_path']                  = 'Caminho completo (diretório) do iMA';
$string['file_jar_path_help']             = 'Explicação adicional sobre o caminho do iMA';
$string['file_jar_path_help_help']        = 'Se HTML/JavaScript: o caminho do iMA será usado para criar um sub-diretório e explodir dentro dele todo o conteúdo '.
        ' do pacote ZIP (a ser incorporado).'; //TODO be used instead of 'file_jar_help' and 'file_jar_help_help'
...
$string['graphic_help']                   = 'Opção para apresentar alguns gráficos relacionados com todas as submissões neste bloco de atividades';
$string['group']                          = 'Grupo';
$string['hbar_blue']                      = '';
$string['hbar_blue_r']                    = '';
$string['hbar_green']                     = '';
...
$string['help_ilm_help']                  = 'Opção para mostrar um resumo de todos os iMA disponíveis no iTarefa';
...
$string['import_activity']                = 'Importar atividade';
$string['import_activity_success']        = 'A atividade foi importada com sucesso.';
$string['import_activities_success']      = 'As atividades foram importadas com sucesso.';
...
$string['import_ilm_help']                = "Importar um novo <a href='https://www.matematica.br/ia/#iLM' title='Veja um descrição mais completa'
 target='_blank'>iMA</a>, usando um pacote <tt>IPZ</tt>: ele deve conter o arquivo '<tt>ilm-application.xml</tt>' (com todos os campos necessários para um iMA)
 e conter todos os arquivos do referido iMA.";
$string['import_ilm_about']               = "Sob esta opção, é possível inserir um novo iMA (ou uma nova versão de um iMA já presente).
 <br/>
 Aqui deve ser usado um pacote <tt>IPZ</tt>, basicamente um arquivo <tt>ZIP</tt> contendo o arquivo '<tt>ilm-application.xml</tt>' e todos os arquivos do iMA.
 <br/>
 O arquivo '<tt>ilm-application.xml</tt>' deve ter todas as informações necessárioas para um iMA
 (name, version, type, description, url, extension, file_jar, file_class, width, height,
  evaluate, reevaluate, editingbehavior, submissionbehavior, action_buttons).<br/>
 Uma descrição mais completa do '<tt>ilm-application.xml</tt>' pode ser visto
 <a href='https://www.matematica.br/ia/about_ilm-application.html' title='Veja uma descrição mais completa' target='_blank'>aqui</a>.";
$string['import_statement_empty']         = 'Nenhuma atividade interativa foi encontrada nesse curso.';
$string['import_statement_no_exercise']   = 'Selecione pelo menos um exercício para importar';
...
$string['mean_score_title']               = 'A razão: número total de estudiantes com respostas corretas dividido pelo número de estudantes (M)';
...
$string['notifications_help']             = 'Página que permite visualizar todos os novos recados em atividades deste bloco';
...
$string['print_help']                     = 'Apresentar uma página com formatação em texto puro para possibilitar copiar/colar';
...
$string['report_help']                    = 'Opção para apresentar um resumo de todos os envios de todos os estudantes para este bloco de atividades';
$string['report_menu_help']               = 'Sub-opções de relatórios: todas as submissões; gráficos; iMA';
$string['report_total_students']          = 'Total de estudentes na classe';
$string['report_total_submissions']       = 'Total de submissões';
...
$string['results_help']                   = 'Esta opção apresenta um resumo de seus resultados neste bloco de atividades';
...
$string['settings_see_activities']        = 'Ver todas as actividades de iMA';
$string['settings_see_activities_help']   = 'Para cada curso, buscar todas as actividades de iMA (considerando todos os iMA instalados)';
$string['show']                           = 'Mostrar';
$string['show_answer']                    = 'Mostrar resultado da avaliação automática aos alunos?';
$string['show_iassign']                   = 'Exibir atividade';
$string['show_ilm']                       = 'Exibir este iMA';
...
$string['standard_deviation_title']       = 'Desvio padrão (populacional): raíz quadrada de PV';
...
$string['sum_activity_title']             = 'O número de exercícios neste bloco de atividades iTarefa (NE)';
...
$string['sum_student_title']              = 'O número de estudantes neste curso/classe (NS)';
...
$string['type_ilm_help']                  = 'iIarefa está preparado para receber iMA dos tipos HTML (HTML5) e Java';
