...
$string['activities_page_help']           = 'Opciones de gestión relacionadas con actividades de bloque';
...
$string['add_ilm_iassign']                = 'Agregar uno iMA';
$string['add_ilm_iassign_help']           = 'Agregar un nuevo <a href="https://www.matematica.br/ia/#iLM" title="ver una descripción más completa de iMA" target="_blank">iMA</a>, ' .
  ' rellenando un formulario y enviando un ZIP (o JAR) con iMA. Atención: considerando el paquete HTML/JS, "index.html" debe estar en la raíz del ZIP.';
$string['add_ilm_iassign_about_ilm']      = 'Uno <a href="https://www.matematica.br/ia/#iLM" title="ver una descripción más completa" target="_blank">iMA</a> es cualquier sistema Web educativo';
...
$string['all_submissions_manager_help']   = 'Página que permite administrar todas los envios de todos los estudiantes, por actividad';
$string['all_submissions_manager_confirm'] = '¿Estás seguro de que quieres eliminar?';
$string['all_submissions_manager_date']   = 'Fecha';
$string['all_submissions_manager_next']   = 'Próximo';
...
$string['auto_evaluate_name_config_help'] = 'Página para seleccionar actividades (de este bloque) para ser reevaluados';
...
$string['coefficient_variation_title']      = 'La variación (PV) - sobre NS';
$string['comment']                        = 'Comentarios';
$string['comment_not_answer_this']        = 'No responda a esta mensaje'; 
...
$string['confirm_del_iassign']            = 'Actividad eliminada con éxito.';
$string['confirm_del_ilm']                = 'Usted está seguro de que desea eliminar el iMA <b>{$a}</b>?';
$string['confirm_del_ilm_sure1']          = '¡Este iMA tiene {$a->num} envíos a sus actividades! Vea su identificación ({$a->id}) y número de envíos a seguir:';
$string['confirm_del_ilm_sure2']          = 'Haga clic para verificar esta actividad (id, #submissions) - deberá cambiar su iMA';
$string['confirm_del_ilm_sure3']          = '¡Este iMA tiene {$a->num} actividades! Antes de decidir eliminarlo, registre sus ID: {$a->id}';
...
$string['data_file_html_static']          = "Para agregar un iMA (codificado en HTML/JS), es suficiente enviar un solo paquete ZIP con todos sus archivos
 en el campo suguiente. También es posible enviar un iMA en el antiguo formato de applet/Java, enviando un archivo JAR en el campo siguiente.";
...
$string['edit_ilm']                       = 'Editar informações sobre iMA';
...
$string['error_confirm_del_iassign']      = 'Ocurrió algún tipo de error al eliminar la tarea. Comunique al administrador/professor.';
...
$string['error_duplicated_activity_1']    = 'Error: ¡algo sale mal durante la duplicación de actividad!';
...
$string['error_exercise_removed']         = 'Algo sale mal al eliminar la actividad. Tal vez su maestro retiró este ejercicio. Por favor, informe a su profesor.';
$string['error_file_dupl_1']              = 'Error: no fue posible duplicar este archivo, ¡quizás ya existe!';
$string['error_file_exists']              = 'Erro: Ya existe uno directorio con esse nombre. Por favor, ingresse otro nombre.';
...
$string['error_file_not_exists']          = 'Error: Archivo no existente!';
$string['error_file_null_iassign']        = 'Error: El nombre do archivo está vazio.';
$string['error_folder_permission_denied'] = 'Error: No hay permiso para modificar archivos en el directorio de iMA. ' .
  'Por favor, usted debe verificar los permisos de directorio de iMA (prerrogativa de admin Moodle)';
$string['error_folder_permission_create'] = 'iMA error de creación: directorio sin permiso';
$string['error_folder_permission_dir']    = 'Directorio: ';
$string['error_folder_permission_ilmdir'] = 'Directorio de iMA: ';
$string['error_folder_permission_ilmver'] = 'Directorio de versión de iMA: ';
...
$string['error_import_ilm_version_type']  = 'Nombre, versión y tipo: ';
$string['error_import_ilm_version_exist'] = 'Ya existe un iMA con este nombre y versión';
...
$string['error_xml_ilm']                  = 'Error: el archivo XML no se encontró en el paquete enviado o está corrupto.';
$string['error_xml_missing']              = 'Error: el archivo XML carece de los siguientes atributos: ';
$string['error_zip_ipz']                  = 'Error de creación del iMA: falla en el paquete ZIP o IPZ';
$string['error_zip_ipz_more_directories'] = 'Se encontraron al menos dos subdirectorios dentro del paquete: "{$a->dir1}" y "{$a->dir2}"';
$string['error_zip_ipz_file_in_pack']     = 'Se encontró al menos un archivo (distinto de "ilm-application.xml") en el nivel raíz del paquete:';
$string['error_zip_ipz_single_directory'] = 'El paquete ZIP o IPZ debe tener todos sus archivos dentro de un solo directorio.';
...
$string['export_csv_help']                = 'Exportar un archivo CSV con toda la calificación a todas las actividades de todos los estudiantes';
$string['export_all_submissions']         = 'Exportar envíos';
$string['export_all_submissions_help']    = 'Exportar un paquete ZIP con todos los envíos, de todos los estudiantes a cada una de estas actividades';
...
$string['file_class_form']                = 'Explicación sobre el campo "file_class"';
$string['file_class_form_help']           = 'Considerando iMA en HTML/JavaScript, este campo debe tener su HTML inicial.' .
        'Considerando iMA en Java, el campo "file_class" debe tener su clase principal (e.g. "IgeomApplet" para lo iGeom).';
...
$string['file_ilm_recover_help']          = 'Esta operación recuperará todos los archivos, con todas las actividades de iMA utilizadas en este curso.<br>'.
        'Los nombres de los archivos serán (casi) los nombres de las actividades  ';
$string['file_jar']                       = 'Nombre del paquete iMA (JAR, si es Java; ZIP o TGZ, si es HTML/JavaScript)';
$string['file_jar_path']                  = 'Ruta completa (directorio) del archivo';
$string['file_jar_help']                  = 'Explicación sobre el campo "file_jar"';
$string['file_jar_help_help']             = 'Si el iMA está implementado en HTML/JavaScript: este campo es el nombre de su archivo HTML inicial (debe incluir el prefijo "ilm/"). ' .
        'Si el sistema está implementado en Java: este campo es el nombre de su archivo JAR';
$string['file_jar_path_help']             = 'Adicional explanation about iLM path'; //TODO be used instead of 'file_jar_help' and 'file_jar_help_help'
$string['file_jar_path_help_help']        = 'Si HTML/JavaScript: la ruta del iMA se utilizará para crear un subdirectorio y desglosar todo el contenido del paquete ZIP en él.';
...
$string['graphic_help']                   = 'Opción para presentar algunos gráficos relacionados con todas los envios neste bloque de actividades';
$string['group']                          = 'Grupo';
$string['hbar_blue']                      = '';
$string['hbar_blue_r']                    = '';
$string['hbar_green']                     = '';
...
$string['help_ilm_help']                  = 'Opción para mostrar un resumen de todos los iMA disponibles en iTarea';
...
$string['hide_ilm']                       = 'Ocultar este iMA';
...
$string['import_ilm_help']                = "Importer un nouveau  <a href='https://www.matematica.br/ia/#iLM' title='see a more complete description'
 target='_blank'>iMA</a>, en utilisant un package <tt>IPZ</tt>: il doit avoir le fichier '<tt>ilm-application.xml</tt>'
 (avec toutes les informations nécessaires) et tous les fichiers du iMA.";
$string['import_ilm_about']               = "Bajo desta opción, es posible insertar un nuevo iMA (o una nueva versión del iMA anterior).
 <br/>
 Utiliza un paquete <tt>IPZ</tt>, básicamente un archivo <tt>ZIP</tt> que contiene le descriptor '<tt>ilm-application.xml</tt>' y todos los archivos de este iMA.
 <br/>
 El '<tt>ilm-application.xml</tt>' debe tener la información necesaria de un iMA
 ...
 <br/>
 <a href='https://www.matematica.br/ia/about_ilm-application.html' title='Ver una descripción más completa' target='_blank'>Aquí</a>
 se puede ver una descripción completa de '<tt>ilm-application.xml</tt>'.";
...
$string['mean_score']                     = 'Media de correctas';
$string['mean_score_title']               = 'La proporción: número total de estudiantes con respuestas correctas dividido por el número de estudiantes (M)';
...
$string['notifications_help']             = 'Página que permite visualizar todas las nuevas notificaciones en cualquier actividad de este bloque';
...
$string['print_help']                     = 'Presente una página con texto sin formato para permitir copiar/pegar';
...
$string['report_help']                    = 'Opción para presentar un resumen de todas las presentaciones enviadas por todos los estudiantes en este bloque de actividades';
$string['report_menu_help']               = 'Sub-opciones de report: todos los envios; gráficos; iMA';
$string['report_total_students']          = 'Estudiantes totales en la clase';
$string['report_total_submissions']       = 'Total de envios';
...
$string['results_help']                   = 'Esta opción presenta un resumen de sus resultados en este bloque de actividades';
...
$string['settings_see_activities']        = 'Ver todos las actividades de iMA';
$string['settings_see_activities_help']   = 'Para cada curso, busque todas las actividades de iLM (considerando todos los iLM instalados)';
$string['show']                           = 'Mostrar';
$string['show_answer']                    = 'Mostrar resultado de la evaluación automática a los alumnos?';
$string['show_iassign']                   = 'Mostrar tarea';
$string['show_ilm']                       = 'Mostrar este iMA';
...
$string['standard_deviation_title']       = 'Desviación típica (población completa): raíz cuadrada de PV';
...
$string['sum_activity_title']             = 'Le nombre d\'exercices dans ce bloc d\'activités iTarea (NE)';
...
$string['sum_student_title']              = 'El número de estudiantes en este curso/clase (NS)';
...
$string['type_ilm_help']                  = 'iIarea está preparado para recibir iMA de tipo HTML (HTML5) y Java';
